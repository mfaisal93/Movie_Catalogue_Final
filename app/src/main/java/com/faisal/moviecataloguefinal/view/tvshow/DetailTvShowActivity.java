...
public class DetailTvShowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TvShow data = getIntent().getParcelableExtra(EXTRA_TV);
        ...
        floatingAB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isFavo()) {
                    ...
                    Toast.makeText(DetailTvShowActivity.this, R.string.delete, Toast.LENGTH_SHORT).show();
                    floatingAB.setImageResource(R.drawable.ic_favorite_border);
                } else {
                    tvShowFavorite.setId(data.getId());
                    tvShowFavorite.setTitle(data.getName());
                    ...
                    Toast.makeText(DetailTvShowActivity.this, R.string.result, Toast.LENGTH_SHORT).show();
                    floatingAB.setImageResource(R.drawable.ic_favorite);
                }
            }
        });
    ...
    private boolean isFavo() {
        boolean favo = false;
        Cursor id = tvShowHelper.queryById(String.valueOf(Id));
        id.moveToFirst();
        if (id.getCount() > 0) {
            Id = id.getInt(id.getColumnIndexOrThrow(ID));
            favo = true;
        }
        return favo;
    }
