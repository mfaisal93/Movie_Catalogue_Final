...
public class DetailMovieActivity extends AppCompatActivity {
        ...
        floatingAB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isFavo()) {
                    ...
                    Toast.makeText(DetailMovieActivity.this, R.string.delete, Toast.LENGTH_SHORT).show();
                    floatingAB.setImageResource(R.drawable.ic_favorite_border);
                } else {
                    ...
                    Toast.makeText(DetailMovieActivity.this, R.string.result, Toast.LENGTH_SHORT).show();
                    floatingAB.setImageResource(R.drawable.ic_favorite);
                }
            }
        });
    ...
    private boolean isFavo() {
        boolean favo = false;
        Cursor id = movieHelper.queryById(String.valueOf(Id));
        id.moveToFirst();
        if (id.getCount() > 0) {
