...
import com.faisal.moviecataloguefinal.view.movie.DetailFavoriteMovieActivity;
...
public class FavoriteMovieAdapter extends RecyclerView.Adapter<FavoriteMovieAdapter.FMovieViewHolder> {
    ...
    public void onBindViewHolder(@NonNull FMovieViewHolder holder, int position) {
        ...
        holder.toDetail.setOnClickListener(v -> {
                Intent i = new Intent(context, DetailFavoriteMovieActivity.class);
                i.putExtra(DetailFavoriteMovieActivity.EXTRA_MOVIEDB, movieFavoritedb);
