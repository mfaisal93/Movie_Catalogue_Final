...
public class MovieFavoriteWidget extends AppWidgetProvider {
    ...
    public static final String EXTRA_ITEM = "com.faisal.moviecataloguefinal.EXTRA_ITEM";
    private static final String TOAST_ACTION = "com.faisal.moviecataloguefinal.TOAST_ACTION";

    private static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        Intent intent = new Intent(context, MovieFavoriteService.class);
